    ...
    >
      ...
      >
        <motion.div
          ...
          className="absolute -left-28 -top-12 -translate-x-full -translate-y-1/2"
        >
          <Image
        ...
        <motion.div
          ...
          className="absolute -left-16 -top-6 -translate-x-full -translate-y-1/2"
        >
          <Image
        ...
        <motion.div
          ...
          className="absolute -right-48 top-28 z-20 -translate-y-1/2 translate-x-full"
        >
          <Image
